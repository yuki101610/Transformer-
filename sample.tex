...
\begin{frame}{Word Embedding (WE)}
    \begin{figure}[bthp]
        \centering
        \includegraphics[width=0.7\linewidth]{Embeddingの流れ.png}
    \end{figure}
\end{frame}
...
\section{Attentionの応用(KVキャッシュ)}
\begin{frame}{Attentionの応用}
    \begin{figure}[bthp]
    \centering
    \includegraphics[width=1\linewidth]{Attention機構の発展.png}
    \end{figure}
\end{frame}
