...
\begin{frame}{「状態更新の追跡」実験}
    \begin{enumerate}\scriptsize
        ...
        \begin{itemize}\scriptsize
            \item Clean1「Context: Sandra moved to the kitchen. John travelled to the kitchen. Question: Where is John? Answer:」
            \item Corrupted1「Context: Sandra moved to the kitchen. John travelled to the bedroom. Question: Where is John? Answer:」
            \vspace{0.3em}
            \item Clean2「Context: Sandra moved to the kitchen. John travelled to the kitchen. John travelled to the bathroom. Question: Where is John? Answer:」
            \item Corrupted2「Context: Sandra moved to the kitchen. John travelled to the kitchen. John travelled to the playground. Question: Where is John? Answer:」
        \end{itemize}
        \vspace{0.3em}
...
\begin{frame}{実験1 結果}
    \begin{columns}[c]
        ...
        \begin{figure}[bthp]
            \centering
            \includegraphics[width=1\linewidth]{gemma_babi_task1_rs_s_patching.png}
        \end{figure}
        \column{0.5\textwidth}
        \begin{figure}[bthp]
            \centering
            \includegraphics[width=1\linewidth]{gemma_babi_task1_rs_m_patching.png}
        \end{figure}
    \end{columns}
    \vspace{0.5em}
    \begin{itemize}\scriptsize
        \item L0からL17,18 正解トークンの位置に重要な情報が集約されている
        \item L17,18から最終トークン位置に情報が徐々に移動
    \end{itemize}
\end{frame}
...
\begin{frame}{実験2 結果}
    \begin{columns}[c]
        ...
        \begin{figure}[bthp]
            \centering
            \includegraphics[width=0.7\linewidth]{gemma_babi_task1_head_s_patching.png}
        \end{figure}
        \column{0.5\textwidth}
        \begin{figure}[bthp]
            \centering
...
\begin{frame}{実験4 結果}
    \begin{columns}[c]
        ...
        \begin{figure}[bthp]
            \centering
            \includegraphics[width=1\linewidth]{gemma_babi_task1_mlp_s_patching.png}
        \end{figure}
        \column{0.5\textwidth}
        \begin{figure}[bthp]
            \centering
            \includegraphics[width=1\linewidth]{gemma_babi_task1_mlp_m_patching.png}
        \end{figure}
    \end{columns}
    \begin{itemize}\scriptsize
