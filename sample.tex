...
\begin{frame}{「状態更新の追跡」に関する研究}
    ...
    \begin{enumerate}\scriptsize
        ...
        \end{itemize}
        \vspace{0.3em}
        \item 状態検索回路（State Retrieval Circuit）
        \begin{itemize}\scriptsize
            \item 状態を明示的に更新せず，質問時に関連する記述を検索する
            \item 例：
            「鍵はどこ？」
            という質問から，
            「鍵は棚へ移された」
...
\begin{frame}{「状態更新の追跡」実験}
    \begin{enumerate}\scriptsize
        ...
        \end{itemize}
        \vspace{0.3em}
        \item 実験2で最も影響を与えたL19-H1に対してQとVのアテンションマップ
    \end{enumerate}
\end{frame}
...
\begin{frame}{実験2 結果}
    \begin{columns}[c]
        ...
        \begin{figure}[bthp]
            \centering
            \includegraphics[width=1\linewidth]{gemma_babi_task1_head_s_patching.png}
        \end{figure}
        \column{0.5\textwidth}
        \begin{figure}[bthp]
            \centering
            \includegraphics[width=1\linewidth]{gemma_babi_task1_head_m_patching.png}
        \end{figure}
    \end{columns}
\end{frame}
...
\begin{frame}{実験4 結果}
    \begin{figure}[bthp]
        \centering
        \includegraphics[width=0.8\linewidth]{gemma_babi_task1_l19_h1_attention_map.png}
    \end{figure}
\end{frame}
