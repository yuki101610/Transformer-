...
\section{計算過程の解釈・解析}
\begin{frame}{計算過程の解析・解釈}
    \begin{itemize}
            \item \textcolor{cyan}{注意パターンの観察}
            \item 語彙空間への射影
            \item 出力への影響度
        \end{itemize}
\end{frame}
...
\begin{frame}[allowframebreaks]{参考文献}
    ...
    \begin{thebibliography}{99}
        ...
        \bibitem{item6}
        John Hewitt, Natural Language Processing with Deep Learning CS224N/Ling284, https://web.stanford.edu/class/cs224n/slides/cs224n-spr2024-lecture08-transformers.pdf. アクセス日2026/5/1
        \bibitem{item7}
